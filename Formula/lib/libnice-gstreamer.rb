class LibniceGstreamer < Formula
  ...
  # This is the symlink we set up in GStreamer's keg. (See the `post_install` method in `gstreamer.rb`.)
  link_overwrite "lib/gstreamer-1.0/libgstnice.dylib", "lib/gstreamer-1.0/libgstnice.so"
